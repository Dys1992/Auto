...
//        System.out.println(HttpUtils.senGet("http://cnzhxsrvweixin.17u.cn/FlightWeiXinQueryInfo.ashx","Departure=SHA&Arrival=PEK&DepartureDate=2018-02-26&userIp=012345&flat=174&ProductType=1&gettype=0&Force=2"));
        ...
        System.out.println( HttpUtils.sendPost(url,param));
